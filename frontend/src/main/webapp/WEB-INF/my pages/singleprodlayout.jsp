        	...
        	<div class="row">
               <div class="col-xs-4 item-photo">
                ...
                <div class="col-xs-5" style="border:0px solid gray">
                    <<h3>${productModelAgent.getProductName()}</h3>    
					 <%-- 
                    <h5 style="color:#337ab7">${prod.productCategory()} <a href="#">${prod.getProductSuplier()}</a> · <small style="color:#337ab7"> </small></h5>
         --%>
            
                    
                    <h3 style="margin-top:0px;">${productModelAgent.getProductPrice()}</h3>
        
                    <div class="section">
                        <h6 class="title-attr" style="margin-top:15px;" ><small>Limited offer!!</small></h6>                    
                        <div>
...
<!--                         <li class="active">Detalle del producto</li>
 ...
 -->                    </ul>
             ...
             <%--            <p style="padding:15px;">${prod.productDescription()}
 --%>                            <!-- <small>
